...
class Toplevel1:
    def __init__(self, top=None):
        ...
        font9 = "-family {Segoe Print} -size 10 -weight bold -slant italic "
        font8 =  "-family {Times New Roman} -size 16 -weight bold"
        font7 =  "-family {Times New Roman} -size 8 -weight bold"
        ...
        self.Label1.configure(text='''AUTOMATIC NUMBER PLATE RECOGNITION''')
        self.Label1.configure(width=384)
        self.Label2 = tk.Label(top)
        self.Label2.place(relx=0.855, rely=0.5, height=31, width=94)
        self.Label2.configure(background="#d9d9d9")
        self.Label2.configure(disabledforeground="#a3a3a3")
        self.Label2.configure(font=font7)
        self.Label2.configure(foreground="#000000")
        self.Label2.configure(text='''MADE BY:''')
        self.Label2.configure(width=94)
        self.Label3 = tk.Label(top)
        self.Label3.place(relx=0.808, rely=0.557, height=21, width=171)
        self.Label3.configure(background="#d9d9d9")
        self.Label3.configure(disabledforeground="#a3a3a3")
        self.Label3.configure(font=font7)
        self.Label3.configure(foreground="#000000")
        self.Label3.configure(text='''ARAOYE ADEDAMOLA EMMANUEL''')
        self.Label3.configure(width=171)
        self.Label4 = tk.Label(top)
        self.Label4.place(relx=0.855, rely=0.8, height=31, width=94)
        self.Label4.configure(background="#d9d9d9")
        self.Label4.configure(disabledforeground="#a3a3a3")
        self.Label4.configure(font=font7)
        self.Label4.configure(foreground="#000000")
        self.Label4.configure(text='''SUPERVISOR:''')
        self.Label4.configure(width=100)
        self.Label5 = tk.Label(top)
        self.Label5.place(relx=0.808, rely=0.857, height=21, width=170)
        self.Label5.configure(background="#d9d9d9")
        self.Label5.configure(disabledforeground="#a3a3a3")
        self.Label5.configure(font=font7)
        self.Label5.configure(foreground="#000000")
        self.Label5.configure(text='''ENGR AGBOLADE''')
        self.Label5.configure(width=170)
        ...
        self.Label7.place(relx=0.012, rely=0.933, height=21, width=55)
        self.Label7.configure(background="#d9d9d9")
        self.Label7.configure(disabledforeground="#a3a3a3")
        self.Label7.configure(font=font7)
